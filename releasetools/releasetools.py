def FullOTA_Assertions(info):
    ...
    info.script.AppendExtra('ifelse(file_getprop("/vendor/build.prop","ro.vendor.build.date.utc") != "1560313009",');
    ...
    info.script.AppendExtra('ui_print("          Expected version: XXU3CSF9         ");');
    info.script.AppendExtra('ui_print("=============================================");');
